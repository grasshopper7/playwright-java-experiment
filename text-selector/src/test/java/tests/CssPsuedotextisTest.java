...
public class CssPsuedotextisTest extends TextSelectorBaseTest {
	...
	*/
	...
	public void simpleExactMatch() {
		...
		locator = page.locator("span:text-is('Playwright is easy to use')");
	...
	public void simpleSubstringMatch() {
		page.setContent(SIMPLE_CONTENT);
		locator = page.locator("span:text-is('Playwright is')");
	...
	public void complexSpanIdDeepExactMatch() {
		...
		locator = page.locator("span:text-is('things')");
	...
	public void complexSpanIdInnerExactMatch() {
		page.setContent(COMPLEX_CONTENT);
		locator = page.locator("span:text-is('the irritating')");
	...
	public void complexSpanIdInnerAllTextNodesExactMatch() {
		page.setContent(COMPLEX_CONTENT);
		locator = page.locator("span:text-is('the irritating things')");
	...
	public void complexSpanIdInnerAllTextNodesSubstringMatch() {
		page.setContent(COMPLEX_CONTENT);
		locator = page.locator("span:text-is('irritating things')");
	...
	public void complexSpanIdOuter1TopTextNodeExactMatch() {
		page.setContent(COMPLEX_CONTENT);
		locator = page.locator("span:text-is('most of')");
	...
	public void complexSpanIdOuter1BottomTextNodeExactMatch() {
		page.setContent(COMPLEX_CONTENT);
		locator = page.locator("span:text-is('about')");
